...
<html>
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="deptForm"  action="${pageContext.request.contextPath}/notice/edit">
        <input type="hidden" name="id" id="id" value="${notice.id }" >
        <input type="hidden" name="userId" id="userId" value="${sessionScope.user_session.id}" >
          ...
          <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <textarea placeholder="请输入内容，不少于5个汉字" id="content" name="content" class="layui-textarea">${notice.content }</textarea>
                    </div>
                </div>
          <div class="layui-form-item">
