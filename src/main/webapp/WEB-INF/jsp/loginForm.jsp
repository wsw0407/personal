...
<%--        <div  style="background-color:green;width: 1360px;height:610px; float:left;"> --%>
       ...
       <div class="testSlider" style="margin-left:-15px;"></div>
		 ...
		 <div id="register"  class="register" style="height:370px;margin-top:150px;margin-left:205px;opacity:0.9;">
            ...
            <form  method="post" action="${pageContext.request.contextPath}/login" name="check-form" id="toLoginForm">
                
                <div class="default" style="margin-top:40px;">
                    <input 	data-form="uname" type="text" placeholder="请输入登录名"  onchange="tocheckLoginname()"  id="loginname" name="loginname" value="admin"/>
                </div>
                ...
                <div class="default">
                    <input id="password" name="password"
									value="admin123" data-form="upwd" type="password" placeholder="请输入账号密码 " />
                </div>
              ...
              <div class="default" >
                ...
                <div class="submit" style="margin-top: 12px;"> 
                        ...
                        <a  href="javascript:;" onclick="location.href='${pageContext.request.contextPath}/registCode';" style="">没有账号？立即注册</a>
                       
                        <span class="notice">
                        
                          <a href="javascript:;" onclick="location.href='${pageContext.request.contextPath}/repassword';">忘记密码</a>
                        </span>
