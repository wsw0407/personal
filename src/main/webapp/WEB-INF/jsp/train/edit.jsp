...
$(function(){
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="deptForm"  action="${pageContext.request.contextPath}/train/edit">
        <!-- id为员工信息id（也就是全局id） -->
        <input type="hidden" name="id" id="id" value="${train.id }" >
          ...
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${train.empname }">
          ...
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  <select id="completion" name="completion" class="valid">
                    ...
                    <option value="${line.id}" <c:if test="${train.completion == line.id }">selected</c:if> >${line.name}</option>
                    </c:forEach>
                  </select>
              </div>
