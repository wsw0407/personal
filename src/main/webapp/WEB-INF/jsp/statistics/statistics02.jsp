...
$.ajax({
    method:'post',
    url:'${pageContext.request.contextPath}/echartsData1',
    dataType:'json',
    success:function(data){
        initChat1(data);
    }
...
<div style="width:100%;height:190%;margin-top:-30px; border:0;" class="main_tabbor">
	...
	$.ajax({
	    method:'post',
	    url:'${pageContext.request.contextPath}/echartsData2',
	    dataType:'json',
	    success:function(data){
...
$.ajax({
    method:'post',
    url:'${pageContext.request.contextPath}/echartsData3',
    dataType:'json',
    success:function(data){
        initChat3(data);
    }
...
function initChat3(data){
	...
	for(var i=0;i<data.length;i++){
    	...
    	if(data[i].name=='江苏'){
    		var y11=data[i].value;
    	}
    	if(data[i].name=='河南'){
    		var y17=data[i].value;
    	}
    	if(data[i].name=='浙江'){
    		var y12=data[i].value;
    	}
    	if(data[i].name=='甘肃'){
    		var y26=data[i].value;
    	}
     };
