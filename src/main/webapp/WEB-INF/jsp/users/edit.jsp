...
<html>
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="deptForm"  action="${pageContext.request.contextPath}/user/edit">
              ...
              <div class="layui-input-inline">
                  <select  name="statusId" class="valid">
						   <c:forEach items="${requestScope.status_list}" var="dept">
						   		<c:choose>
			    					<c:when test="${user.statusId == dept.id }">
