...
<div style="width: 1360px;height:48px; background-color:RGB(43,48,59) ">
      <ul style="margin-left: 40px;padding-top:6px">
        <li style="display: inline-block;"><h1><a href="${pageContext.request.contextPath}/loginForm.html" style="color:white;font-size:20px;">创新创业型小微企业的人力资源管理平台</a></h1></li>
        <li style="display: inline-block; margin-left: 120px;"><p style="font-size:14px;color: rgb(130,130,130)">重置密码</p></li>
        <li style="display: inline-block; margin-left: 60px;"><a href="${pageContext.request.contextPath}/loginForm.html" style="font-size:14px;color:rgb(130,130,130); ">首页</a></li>
		...
		<div class="register" style="height:360px;margin-top:150px;margin-left:205px; opacity:0.9;" >
            <div class="title">
                ...
                <div style="height: 10px;margin-top: 15px;">
                    <input id="updata_message" disabled="disabled" size="50px;" value="${user.loginname}"style= "background-color:transparent;border:0;color: red"/>
                </div>
            </div>
            <form action="${pageContext.request.contextPath}/rePassword?loginname=${user.loginname}" method="post" id="rePasswordForm">
