...
<html>
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="deptForm"  action="${pageContext.request.contextPath}/dept/add">
        <input type="hidden" name="id" id="id" value="${dept.id }" >
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                 ...
                 placeholder="不少于5个汉字"   autocomplete="off" class="layui-input" value="${dept.remark }">
              </div>
          ...
          <div class="layui-form-item">
              ...
              <input id="L_repass" type="submit" value=" 提交" class="layui-btn" lay-filter="add" lay-submit=""/>
