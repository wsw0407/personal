  ...
  <body onbeforeunload="alert('===========')">
    <div class="x-body">
        ...
        <input type="hidden" name="id" id="id" value="${employee.id}" >
            ...
            <h2 style="margin-left: 140px;margin-bottom: 15px">${message}</h2>
          ...
          <div class="layui-form-item" >
            ...
            <div class="layui-form-item" >
             ...
             <div class="layui-form-item" >
              <label for="education_id" class="layui-form-label">
           ...
           <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="email" name="email" disabled required="" lay-verify="required"
                  autocomplete="off" class="layui-input" value="${sessionScope.user_session.email }">
              </div>
          </div>
           <div class="layui-form-item">
              <label for="phone" class="layui-form-label">
