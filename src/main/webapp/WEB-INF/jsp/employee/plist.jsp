        ...
        <input type="hidden" name="id" id="id" value="${employee.id }" >
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${employee.name ==null ? '未注册' : employee.name}">
          ...
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  <input type="text" id="card_id" name="cardId" required="" lay-verify="required"   disabled="disabled"
