  ...
  <head>
    ...
    $(function(){
        ...
        $("a[id^='down_']").click(function(){
            ...
            $.ajax({
                method:'get',
                url:'${pageContext.request.contextPath}/document/filesExists?filename='+filename,
                dataType:'text',
      ...
      <span class="layui-breadcrumb">
        ...
        <a>
          <cite>文档信息</cite></a>
            ...
            <button id="aaa" type="button" onclick="location.href='${pageContext.request.contextPath}/document/toadd'" class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:inherit;margin-left:75%;;"  lay-submit="" lay-filter="sreach"><i class="layui-icon"></i>增加</button>
    ...
    <div class="x-body">
     ...
     <tr>
            ...
            <td class="td-manage">
              ...
              <a title="编辑"  href='${pageContext.request.contextPath}/document/toedit?id=${doc.id}'>
                <i class="layui-icon">&#xe642;</i>
              </a>
              <a title="删除" onclick="member_del(this,'${doc.id }','${doc.filename}')" href="javascript:;">
                <i class="layui-icon">&#xe640;</i>
              </a>
            </td>
          </tr>
    ...
    <script>
      ...
      function member_del(obj,id,filename){
          layer.confirm('确认要删除吗？',function(index){
              //发异步删除数据
              //等以后再使用异步，这里先使用
              $.get("${pageContext.request.contextPath}/document/delete?id="+id+"&filename="+filename);
              ...
              ,jump: function(obj, first){
                  ...
                  if(!first){
                      ...
                      if(content != null && content != ''){
                          location.href = "${pageContext.request.contextPath}/document/list?pageNo="+obj.curr+"&pageSize="+obj.limit+"&content="+content
                      }else {
                          location.href = "${pageContext.request.contextPath}/document/list?pageNo="+obj.curr+"&pageSize="+obj.limit
                      }
                  }
              }
          });
      ...
      function refresh() {
          ...
          if(content != null && content != ''){
              location.href = "${pageContext.request.contextPath}/document/list"
          }else {
              location.href = "${pageContext.request.contextPath}/document/list?pageNo="+pageNo+"&pageSize="+pageSize
          }
      }
