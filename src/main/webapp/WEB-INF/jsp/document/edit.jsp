...
<html>
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="deptForm" enctype="multipart/form-data" action="${pageContext.request.contextPath}/document/edit">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="title" name="title" required="" lay-verify="required"
                   placeholder="不少于3个汉字" autocomplete="off" class="layui-input" value="${doc.title }">
              </div>
        ...
        <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  placeholder="不少于5个汉字"  autocomplete="off" class="layui-input" value="${doc.remark}">
              </div>
