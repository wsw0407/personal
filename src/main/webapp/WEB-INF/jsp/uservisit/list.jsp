			  ...
			  ,jump: function(obj, first){
				  ...
				  if(!first){
					  ...
					  if(content != null && content != ''){
						  location.href = "${pageContext.request.contextPath}/uservisit/list?pageNo="+obj.curr+"&pageSize="+obj.limit+"&content="+content
					  }else {
						  location.href = "${pageContext.request.contextPath}/uservisit/list?pageNo="+obj.curr+"&pageSize="+obj.limit
					  }
				  }
			  }
		  });
