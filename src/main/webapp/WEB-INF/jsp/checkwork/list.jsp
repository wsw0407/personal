...
<html>
  ...
  <body>
    <div class="x-nav">
      ...
      <button id="bbb" type="button" onclick="location.href='${pageContext.request.contextPath}/checkwork/toadd'" class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:inherit;margin-left:75%;;"  ><i class="layui-icon"></i>增加</button>
    ...
    <div class="x-body">
     ...
     <tr>
            ...
            <td class="td-manage">
             ...
             <a title="编辑"  href='${pageContext.request.contextPath}/checkwork/toedit?id=${checkwork.id}'>
    ...
    <script>
              ...
              ,jump: function(obj, first){
                  ...
                  if(!first){
                      ...
                      if(content != null && content != ''){
                          location.href = "${pageContext.request.contextPath}/checkwork/list?pageNo="+obj.curr+"&pageSize="+obj.limit+"&content="+content
                      }else {
                          location.href = "${pageContext.request.contextPath}/checkwork/list?pageNo="+obj.curr+"&pageSize="+obj.limit
                      }
                  }
              }
          });
      ...
      function refresh() {
          ...
          if(content != null && content != ''){
              location.href = "${pageContext.request.contextPath}/checkwork/list"
          }else {
              location.href = "${pageContext.request.contextPath}/checkwork/list?pageNo="+pageNo+"&pageSize="+pageSize
          }
      }
