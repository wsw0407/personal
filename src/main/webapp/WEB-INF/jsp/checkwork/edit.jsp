...
$(function(){
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="deptForm"  action="${pageContext.request.contextPath}/checkwork/edit">
        <input type="hidden" name="id" id="id" value="${checkwork.id }" >
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${checkwork.empname}">
              ...
              <div class="layui-input-inline">
                  <select id="jobId" name="jobId" class="valid" disabled="disabled">
                    <option value="0">--部门选择--</option>
						   <c:forEach items="${requestScope.job_list}" var="job">
						   		<c:choose>
			    					<c:when test="${checkwork.jobId == job.id }">
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <select id="deptId"  name="deptId"  class="valid" disabled="disabled">
                      <option value="0">--部门选择--</option>
						   <c:forEach items="${requestScope.dept_list}" var="dept">
						   		<c:choose>
			    					<c:when test="${checkwork.deptId == dept.id }">
