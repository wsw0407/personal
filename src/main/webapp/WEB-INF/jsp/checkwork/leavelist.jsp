...
<html>
  ...
  <body>
    <div class="x-nav">
      ...
      <button id="bbb" type="button" onclick="location.href='${pageContext.request.contextPath}/checkwork/toadd'" class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:innert;margin-left:75%;;"  ><i class="layui-icon"></i>增加</button>
    ...
    <div class="x-body">
     ...
     <div style="margin-left: 400px;" id="count1">
         <fkjava:pager
	  	        ...
	  	        style="digg"
	  	        submitUrl="${pageContext.request.contextPath}/checkwork/list?pageIndex={0}"/>
     </div>
