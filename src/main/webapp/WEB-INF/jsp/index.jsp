...
<head>
	...
	//这个事件不能一直点击
		  $(function() { // 页面装载执行
				$("#bt").click(function(){ // 为ID为bt的标签绑定click事件
					$.ajax({
					    method:'get',
					    url:'${pageContext.request.contextPath}/toCreateCode',
					    dataType:'json',
    ...
    $(function(){
    	...
    	$("#main").click(function(){
    		/** parent从主界面进行退出,避免局部刷新*/
    		parent.location = "${pageContext.request.contextPath}/login?loginname=${sessionScope.user_session.loginname}&password=${sessionScope.user_session.password}";
    	})
	});
...
<body oncontextmenu="self.event.returnValue=false" onselectstart="return false">
        ...
        <ul id="nav">
            <li id="uservisit">
                ...
                <ul class="sub-menu">
                   ...
                   <li >
                        <a _href="${pageContext.request.contextPath}/uservisit/list">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>用户访问信息</cite>
                    ...
                    <li>
                        <a _href="${pageContext.request.contextPath}/user/toadd">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>添加用户</cite>
            ...
            <li id="personal">
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/user/topedit?id=${sessionScope.user_session.id}">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>个人信息</cite>
                        </a>
                    </li >
            ...
            <li >
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/dept/list">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>部门列表</cite>
                        </a>
                    </li >
                    <li id="dept">
                        <a _href="${pageContext.request.contextPath}/dept/toadd">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>添加部门</cite>
                        </a>
                    </li >
            ...
            <li >
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/job/list">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>职位列表</cite>
                        </a>
                    </li >
                     <li id="job">
                        <a _href="${pageContext.request.contextPath}/job/toadd">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>添加职位</cite>
                        </a>
                    </li >
            ...
            <li id="employee">
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/employee/list">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>员工列表</cite>
                        </a>
                    </li >
                    <li>
                        <a _href="${pageContext.request.contextPath}/employee/association">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>添加员工</cite>
                        </a>
                    </li >
            ...
            <li id="peremployee">
                ...
                <ul class="sub-menu">
                    ...
                    <li >
                        ...
                        <a _href="${pageContext.request.contextPath}/employee/plist?id=${sessionScope.user_session.empId}"><!--session中获取员工信息的id  -->
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>个人信息</cite>
                        </a>
                    </li >
                    ...
                    <li>
                        <!-- 这里首先需要默认一个员工的id，因为第一次注册登录，没有员工信息，所以这个id如何设置 -->
                        <a _href="${pageContext.request.contextPath}/employee/topadd?id=${sessionScope.user_session.id}"><!--session中获取员工信息的id  -->
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>完善个人信息</cite>
                        </a>
                    </li >
            ...
            <li id="checkwork">
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/checkwork/list">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>考勤查询</cite>
                        </a>
                    </li >
 ...
 <!--新增用户请假功能  部门经理进行审批-->            
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/checkwork/adminleavelist">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>请假申请</cite>
                        </a>
                    </li >
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/checkwork/leaveadd?userId=${sessionScope.user_session.id}">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>我要请假</cite>
                        </a>
                    </li >
 ...
 <!--************************************************************************************* -->                  
            ...
            <li id="pcheckwork">
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/checkwork/plist">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>查看考勤</cite>
                        </a>
                    </li >
...
<!--我的请假直接通过id去查询请假详情列表，简单的查询功能，用户可以删除自己的请假信息   -->                
                  <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/checkwork/pleavelist?id=${sessionScope.user_session.id}">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>我的请假</cite>
                        </a>
                    </li >
...
<!--************************************************************************************* -->            
            ...
            <li id="salary">
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/salary/list">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>薪酬管理</cite>
                        </a>
                    </li >
            ...
            <li id="psalary">
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/salary/pedit?userId=${sessionScope.user_session.id}">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>查看薪酬</cite>
                        </a>
                    </li >
            ...
            <li id="contract">
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/contract/list">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>合同管理</cite>
                        </a>
                    </li >
            ...
            <li id="pcontract">
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/contract/pedit?userId=${sessionScope.user_session.id}">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>查看合同</cite>
                        </a>
                    </li >
            ...
            <li id="train">
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/train">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>培训计划</cite>
                        </a>
                    </li >
                    <!-- 新增培训评价及详细信息 -->
                    <li>
                        <a _href="${pageContext.request.contextPath}/train/trainlist?id=${sessionScope.user_session.id}">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>我的培训</cite>
                        </a>
                    </li >
                    <li>
                        <a _href="${pageContext.request.contextPath}/traindata/list">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>培训资料</cite>
                        </a>
                    </li >
            ...
            <li id ="admintrain">
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a _href="${pageContext.request.contextPath}/train/admintrainlist">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>培训详情</cite>
                        </a>
                    </li >
                    <li>
                        <a _href="${pageContext.request.contextPath}/train/toadd">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>添加培训信息</cite>
                        </a>
                    </li >
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/statistics">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>数据报表</cite>
                        </a>
                    </li >
